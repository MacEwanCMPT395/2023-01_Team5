...
#testing data
cohorts = {"PM11": Cohort("PM11", 40, 1), "PM21": Cohort("PM21", 40, 1), "PM3": Cohort("PM31", 40, 1), "BA1": Cohort("BA11", 40, 1), "GLM21": Cohort("GLM21", 40, 1)}
#globals
...
def max_capacity_reached(cohorts):
    unscehduled_cohorts = []
...
#need to add total lecture hours and lab hours in cohort class
#add total hours in one semester per day
#need to add bool in cohort class if the cohort has a lab

def main():
    max_capacity_reached(cohorts)
